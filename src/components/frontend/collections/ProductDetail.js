...
const history = useHistory();
    ...
    const [numberofdays,setDays] = useState(1);
             ...
             <label className="btn-sm btn-success px-4 mt-2">In stock</label>
                            ...
                            <div className="row">
                                <div className="col-md-3 mt-3">
                                    <div className="input-group">
                                       days:  
                                    <button type="button" onClick={handleDecrementDays} className="input-group-text">-</button>
                                    <div className="form-control text-center">{numberofdays}</div>
                                    <button type="button" onClick={handleIncrementDays} className="input-group-text">+</button>
                                    </div>
                                </div>
